...
export default function Customers() {
  ...
  const handleExport = () => {
    ...
    toast.success("Success", { description: "Customers exported successfully" });
  };
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.success("Success", { description: `Imported ${data.length} customers` });
      fetchCustomers();
    } catch (error) {
      toast.error("Error", { description: "Failed to import customers" });
    }
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/customers/${customerToDelete}`, {
        method: "DELETE",
      });
