...
interface DashboardStats {
  ...
  chartData: { date: string; name: string; sales: number; expenses: number }[];
}
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="col-span-4">
        <CardHeader>
          <CardTitle>Sales & Expenses Overview (Last 7 Days)</CardTitle>
        </CardHeader>
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={stats.chartData}>
                ...
                />
                <Legend />
                <Area type="monotone" dataKey="sales" name="Sales" stroke="#22c55e" fillOpacity={1} fill="url(#colorSales)" />
