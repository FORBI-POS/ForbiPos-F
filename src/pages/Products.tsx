...
export default function Products() {
  ...
  const handleExport = () => {
    ...
    toast.success("Success", { description: "Products exported successfully" });
  };
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.success("Success", { description: `Imported ${data.length} products` });
      fetchProducts();
    } catch (error) {
      toast.error("Error", { description: "Failed to import products" });
    }
